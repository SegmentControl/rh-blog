<template>
    ...
    <section
      class="page-header"
      :style="'background-image: linear-gradient(120deg, '+vblog.topLinearEndColor +', ' + vblog.topLinearBegainColor + ');color: ' + vblog.titleFontColor + ';'"
    >
      ...
      <el-card shadow="never" :body-style="{ padding: '0px' }">
        <el-row>
          ...
          <el-col :span="2" style="text-align: center;">
            <img
              v-popover:bigAvatar
              :src="'http://132.232.94.204:1337'+vblog.avatarUrl.url"
            ...
            >
              ...
              <br />
              <img :src="'http://132.232.94.204:1337'+vblog.avatarUrl.url" style="width: 200px;height: 200px;" />
            </el-popover>
          </el-col>
        </el-row>
      </el-card>
...
import Foot from './components/Foot'
    ...
    mounted() {
      ...
      selectTopbar(index) {
                  ...
                  switch (index) {
                      case "#githubHome":
                          window.open('https://github.com/SegmentControl')
                          break
                      default:
                          window.open('https://juejin.cn/user/1574156384085015')
                          break
                  }
              },
